...
/*
 * @param {Boolean|{stop : Boolean, center : Boolean, color : String, keyCodes : Array|Number}} Boolean (if just wanting to enable/disable) or Object for configuring more options
 */
